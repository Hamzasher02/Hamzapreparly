...
class highSchoolSubjects extends StatefulWidget {
  const highSchoolSubjects({Key? key}) : super(key: key);

  @override
  State<highSchoolSubjects> createState() => _highSchoolSubjectsState();
}

class _highSchoolSubjectsState extends State<highSchoolSubjects> {
  @override
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                  top: 92.h,
                                  left: 30.w,
                                  child: Image.asset("assets/microscope.png",height: 125.h,width: 120.w,)
                              ),

                              Positioned(
                                  top: 128.h,
                                  left: 158.w,
                                  child: Text("GAT SUBJECT",style: TextStyle(fontSize: 19.sp, fontWeight: FontWeight.w400, color: Color(0xff004880,)),)
                              ),

                              Positioned(
                                  top: 150.h,
                                  left: 158.w,
                                  child: Container(margin: EdgeInsets.only(top: 3.h,bottom: 2.h),width: 157.w, height: 4.8.h, decoration: BoxDecoration(color: Colors.black, borderRadius: BorderRadius.circular(20.r)),)),
                              ...
                              Positioned(
                                  top: 178.h,
                                  left: 158.w,
                                  child: Text('from Biological',style: TextStyle(fontSize: 17.sp, fontWeight: FontWeight.w400),)
                              ),
                              Positioned(
                                  top: 196.h,
                                  left: 158.w,
                                  child: Text('Sciences',style: TextStyle(fontSize: 17.sp, fontWeight: FontWeight.w400),)
                              ),
                            ],),
                    ...
                    child: SingleChildScrollView(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            SizedBox(height: 0.1),
                            SmallWhiteContainer(image: "assets/Botany.png", text: "Botany"),
                            SmallWhiteContainer(image: "assets/Zoology.png", text: "Zoology"),
                            SmallWhiteContainer(image: "assets/Microbiology.png", text: "Microbiology"),
                            SmallWhiteContainer(image: "assets/Genetics.png", text: "Genetics"),
                            SmallWhiteContainer(image: "assets/Biotechnology.png", text: "Bio Technology"),
                            SmallWhiteContainer(image: "assets/Microbiology.png", text: "Bio Chemistry"),
