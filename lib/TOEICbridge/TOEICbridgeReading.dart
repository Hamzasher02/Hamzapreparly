...
class TOEICbridgeReading extends StatefulWidget {
  const TOEICbridgeReading({Key? key}) : super(key: key);

  @override
  State<TOEICbridgeReading> createState() => _TOEICbridgeReadingState();
}

class _TOEICbridgeReadingState extends State<TOEICbridgeReading> {
  @override
