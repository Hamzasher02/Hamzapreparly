...
// inorder to use the 'defaultSize' variable for responsiveness we will need to initialize all the late variables and that is done when
// ... we call "SizeConfig().init(context);" in the build method of the screen where we need to access it
...
class SizeConfig {
  ...
  void init(BuildContext context) {          // This function will take 'defaultSize' based on screen height
    ...
    defaultSize = orientation == Orientation.landscape   // taking default size based on height of screen
        ? screenWidth * 0.024
        : screenHeight * 0.024;
  }
}
